    ...
    public function run(): void
    {
        ...
        foreach ($variantsSticksPet as $index => $fragrance) {
            Product::create([
                ...
                'short_description' => 'Premium Natural, Herbal & Cow Dung Based Dhoop Sticks. Charcoal-Free, Bamboo-Free.',
        ...
        foreach ($variantsConesPet as $index => $fragrance) {
            Product::create([
                ...
                'short_description' => 'Premium Natural, Herbal & Cow Dung Based Dhoop Cones. Charcoal-Free, Bamboo-Free.',
