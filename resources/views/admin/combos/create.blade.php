...
@section('header_title', 'Add Combo Pack')
...
<div class="max-w-4xl mx-auto bg-white rounded-2xl border border-slate-100 p-6 sm:p-8 shadow-xs">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            <h3 class="font-serif font-bold text-slate-800 text-lg">Create New Combo Pack</h3>
            <span class="text-xs text-slate-450 mt-1 block">A combo pack calculates its availability dynamically based on its ingredients.</span>
        </div>
    ...
    <form method="POST" action="{{ route('admin.combos.store') }}" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-1.5">
                ...
                <input type="text" name="name" value="{{ old('name') }}" required placeholder="e.g. Daily Meditation Combo Pack"
            ...
            <div class="space-y-1.5">
                ...
                <input type="number" name="price" step="0.01" min="0" value="{{ old('price') }}" required placeholder="e.g. 599.00"
                       class="w-full border border-slate-200 focus:ring-1 focus:ring-[#C49A6C] focus:border-[#C49A6C] rounded-xl text-sm px-4 py-2.5">
            </div>
            ...
            <div class="space-y-1.5">
                ...
                <input type="number" name="sale_price" step="0.01" min="0" value="{{ old('sale_price') }}" placeholder="e.g. 499.00"
                       class="w-full border border-slate-200 focus:ring-1 focus:ring-[#C49A6C] focus:border-[#C49A6C] rounded-xl text-sm px-4 py-2.5">
            </div>
        ...
        <div class="space-y-1.5">
            <label class="text-xs font-bold text-slate-500 uppercase tracking-wider block">Upload Images</label>
        ...
        <div class="bg-amber-50 border border-amber-100 p-5 rounded-2xl space-y-4">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="space-y-1.5">
                    ...
                    <input type="number" name="weight" step="0.001" min="0.001" value="{{ old('weight') }}" required
                           class="w-full border border-slate-200 focus:ring-1 focus:ring-[#C49A6C] focus:border-[#C49A6C] rounded-xl text-sm px-4 py-2.5">
                ...
                <div class="space-y-1.5">
                    ...
                    <input type="number" name="length" min="1" value="{{ old('length', 15) }}" required
                           class="w-full border border-slate-200 focus:ring-1 focus:ring-[#C49A6C] focus:border-[#C49A6C] rounded-xl text-sm px-4 py-2.5">
                </div>
                <div class="space-y-1.5">
                    <label class="text-xs font-bold text-slate-500 uppercase tracking-wider block">Width (cm) *</label>
                    <input type="number" name="width" min="1" value="{{ old('width', 10) }}" required
                           class="w-full border border-slate-200 focus:ring-1 focus:ring-[#C49A6C] focus:border-[#C49A6C] rounded-xl text-sm px-4 py-2.5">
                </div>
                <div class="space-y-1.5">
                    <label class="text-xs font-bold text-slate-500 uppercase tracking-wider block">Height (cm) *</label>
                    <input type="number" name="height" min="1" value="{{ old('height', 8) }}" required
                           class="w-full border border-slate-200 focus:ring-1 focus:ring-[#C49A6C] focus:border-[#C49A6C] rounded-xl text-sm px-4 py-2.5">
                </div>
            </div>
