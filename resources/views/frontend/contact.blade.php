...
@section('content')
    ...
    <div class="relative bg-gradient-to-br from-[#FAF6F0] via-white to-[#FAF6F0] py-16 md:py-24 border-b border-[#C49A6C]/20 overflow-hidden text-center animate-fade-in">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <h1 class="text-3xl sm:text-5xl font-serif font-bold text-gray-955 uppercase tracking-widest mt-3">Contact Us</h1>
            <p class="text-[10px] text-[#C49A6C] uppercase font-bold tracking-widest font-serif mt-2">Connect with Vedic Botanica</p>
